export const metadata = {
  title: "FAQ | AMI Rentals Beach House",
  description:
    "Frequently asked questions about booking, location, pets, check-in, and availability at AMI Rentals Beach House in Bradenton Beach.",
};
      ...
      <section className="py-20">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <FAQ
            ...
            a="AMI Rentals Beach House is in Bradenton Beach on Anna Maria Island, Florida — a short walk to the Gulf in a quiet residential area."
          />
          ...
          <FAQ q="Does the house have a pool?" a="Yes. The home features a private pool exclusively for guests." />
