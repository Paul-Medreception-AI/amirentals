...
export const metadata = {
  title: "Anna Maria Island Location Guides | Bay to Beach House",
  description:
    "Explore Anna Maria Island, Bradenton Beach, Holmes Beach, and nearby coastal spots. Find the best beach areas for your Bay to Beach House stay.",
};
      ...
      <section className="relative overflow-hidden border-b border-sky-100 bg-gradient-to-br from-sky-50 via-white to-emerald-50">
        ...
        <div className="mx-auto max-w-5xl px-6 py-16">
          ...
          <p className="mt-6 max-w-3xl text-lg text-slate-700">
            ...
            you match the vibe you want with a pristine, allergy-friendly stay near the Gulf.
          </p>
