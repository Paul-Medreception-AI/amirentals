...
const ACCENTS = [
  ...
  },
  {
    ...
    highlightCardClass: "border-slate-200 bg-slate-50 text-slate-900",
  },
] as const;
...
export async function generateMetadata({ params }: PageProps): Promise<Metadata> {
  ...
  if (!page) {
    return {
      title: "Pool & Outdoor Living | Bay to Beach House (AMI Rentals)",
      description:
        "Explore pool, outdoor living, and hot tub-friendly luxury stays on Anna Maria Island through AMI Rentals.",
    };
  }
...
export default async function PoolTopicPage({ params }: PageProps) {
  ...
  const isHotTub = page.collection === "hot-tub";
        ...
        <div className="mx-auto max-w-5xl px-6">
          <div className="grid gap-10">
            <section className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm">
              <h2 className="text-2xl font-semibold text-slate-900">AMI Rentals positioning</h2>
