...
export const metadata: Metadata = {
  title: "Romantic & Couples Experiences | Bay to Beach House (AMI Rentals)",
  description:
    "Explore romantic getaways, honeymoons, anniversaries, and luxury weekend escapes near Anna Maria Island. Bay to Beach House (AMI Rentals) is no pets allowed for pristine, allergy-friendly stays with a heated pool + hot tub.",
};
      ...
      <section className="relative overflow-hidden border-b border-sky-100 bg-gradient-to-br from-sky-50 via-white to-emerald-50">
        ...
        <div className="mx-auto max-w-5xl px-6 py-16">
          ...
          <p className="mt-6 text-xs font-semibold uppercase tracking-[0.3em] text-slate-500">
            Luxury couples travel on Anna Maria Island
          </p>
          <h1 className="mt-4 text-4xl font-bold text-slate-900 md:text-5xl">Romantic, Couples &amp; Experience Guides</h1>
          <p className="mt-6 max-w-3xl text-lg text-slate-700">
            These guides are built for travelers planning special trips — romantic getaways, honeymoons, anniversaries,
            and luxury weekends near Anna Maria Island. Bay to Beach House (AMI Rentals) is no pets allowed for pristine,
            allergy-friendly stays with a heated pool + hot tub.
          </p>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-5xl px-6">
          ...
          <section className="mt-12 rounded-2xl border border-slate-200 bg-gradient-to-br from-slate-900 to-sky-900 p-8 text-white shadow-sm">
            <h2 className="text-2xl font-bold">Planning a luxury weekend?</h2>
            <p className="mt-3 max-w-2xl text-white/85">
              Choose an experience guide, then build a simple rhythm: beach time, walkable dining, and a private spa
              backyard (heated pool + hot tub).
            </p>
